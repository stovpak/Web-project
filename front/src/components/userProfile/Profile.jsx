                ...
                <div className="container" >
                    ...
                    <div >
                        ...
                        <ul className="list-group container col-8">
                            ...
                            <button className={" float-right btn btn-link"} onClick={this.onChangeEmail} data-toggle="modal" data-target="#exampleModalCenter">Изменить</button>
                            </li>
                            <li className="list-group-item" name={'surname'}>Фамилия </li>
                            <li className="list-group-item" name={'birth'}>Дата рождения </li>
                            <li className="list-group-item" name = {'password'}>Пароль </li>
                            <li className="list-group-item" name = 'mail'>Почта</li>
                        </ul>
